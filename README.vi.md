...
v3.5.0 là bản stable hiện tại. Bản này thêm hai nhánh documentary và social bắt
buộc, thao tác Playwright sâu, bằng chứng thực thi có hash và coverage gate
fail-closed. Xem
[release notes v3.5.0](docs/release-v3.5.0.md).
...
cho contributor/auditor, dùng `d-research-3.5.0-full.tar.gz`. Profile
