...
v3.5.0-rc.2 là release candidate hiện tại. Bản này thêm hai nhánh documentary
...
[release notes v3.5.0-rc.2](docs/release-v3.5.0-rc.2.md).
...
cho contributor/auditor, dùng `d-research-3.5.0-rc.2-full.tar.gz`. Profile
...
Release candidate: v3.5.0-rc.2. Xem
