# D Research v3.5.0-rc.1

## v3.5.0-rc.1 Release Notes
...
This release candidate freezes the implementation intended for D Research
3.5.0. It is suitable for evaluation and integration testing while exact-SHA
CI, signed-tag, archive, and provenance gates run.
...
Use `d-research-3.5.0-rc.1-runtime.tar.gz` for installation testing or
`d-research-3.5.0-rc.1-full.tar.gz` for development and audit work. Verify
...
The candidate passed 162 Python tests, Ruff, contract and skill validation,
...
this candidate. Synthetic fixtures and automated checks establish behavior and
...
**Full changelog:** [v3.4.2...v3.5.0-rc.1](https://github.com/d-init-d/d-research-skill/compare/v3.4.2...v3.5.0-rc.1)
